...
public class GuiUpdatePacket {
    ...
    public static RegistryFriendlyByteBuf create(RegistryAccess access, Player2NpcTab tab, String action, int value) {
        RegistryFriendlyByteBuf buf = new RegistryFriendlyByteBuf(Unpooled.buffer(), access);
        new GuiUpdatePacket(tab, action, value).write(buf);
        return buf;
    }

    public static RegistryFriendlyByteBuf createText(RegistryAccess access, Player2NpcTab tab, String action, String text) {
        RegistryFriendlyByteBuf buf = new RegistryFriendlyByteBuf(Unpooled.buffer(), access);
